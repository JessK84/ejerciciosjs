...
const nota = Number(prompt("Ingrese el resultado de su examen"));

let respuesta = nota === 10 && "Excelente" || nota <10 && nota >=8 && "Muy Bien!" || nota<8 && nota>=6 && "Aprobado" || nota<6 && "Reprobado" || isNaN(nota) && "No ha ingresado una nota validad" || nota>10 && "IMPOSIBLE!";
