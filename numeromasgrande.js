...
if (isNaN(numero1) || numero1 == null || numero1 == "") {
	...
	if (isNaN(numero2) || numero2 == null || numero2 == "") {
		...
		let mensaje = numero1 > numero2 && alert(`El numero mayor es ${numero1}`) || numero1 < numero2 && alert(`El numero mayor es ${numero2}`) || numero1 === numero2 && alert("Los numeros son iguales");
	}
}